...
aws ec2 run-instances --image-id ami-bf4193c7 --count 1 --instance-type t2.micro --key-name HomeKey.pem --security-group-ids $security_group_id --subnet-id $privsub_id --profile ${profile} --region ${region}
