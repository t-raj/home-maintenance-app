...
function dirapp_setup {
	...
	#NOTE: Technically you would do a git clone of your application here, however, for the sake of example
	#NOTE:  I have it here as a tar and will untar it in the newly created directory
